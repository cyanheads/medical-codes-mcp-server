 ...
 * RxClass records on products (every DEA schedule, all but a few VA classes) —
 * whose absence must never read as the drug lacking it — an RXCUI no bundled
 * source classifies, a `classType` that filtered
